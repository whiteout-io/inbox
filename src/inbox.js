...
define(function (require) {
    ...
    IMAPClient.prototype._init = function () {
        ...
        this.lineparser.on("error", this._onError.bind(this));
    };
    ...
    IMAPClient.prototype.uidListMessages = function (from, to, callback) {
        ...
        this._send( "UID FETCH " + from + ":" + to + " (BODYSTRUCTURE UID FLAGS ENVELOPE" +(this._capabilities.indexOf("X-GM-EXT-1") >= 0 ? " X-GM-LABELS X-GM-THRID" : "") + ")", (function (status) {
            this._collectMailList = false;
    ...
    return {
        ...
        createXOAuthGenerator: createXOAuthGenerator,
