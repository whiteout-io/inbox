...
/**
 * Returns the uids of messages matching all the search terms in the options
 * (see "Finding messages" http://www.skytale.net/blog/archives/23-Manual-IMAP.html and http://tools.ietf.org/html/rfc3501#section-6.4.4)
 * If the options object is empty, the resulting array of UIDs will be empty.
 * 
 ...
 * @param {String} options.from (optional) Mails with the specified sender
 * @param {String} options.to (optional) Mails with the specified receiver
 * @param {String} options.cc (optional) Mails with the specified bcc
 * @param {String} options.bcc (optional) Mails with the specified bcc
 * @param {String} options.body (optional) Mails containing the specified string in the body
 * @param {Function} callback(error, uids) Contains uids of messages matching the search terms, or an error object if an error occurred
 */
